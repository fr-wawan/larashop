...
<body>
    ...
    <div style="min-height: 100%" class="flex-row d-flex align-items-
      ...
      <div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-
        ...
        mb-4" type="text" placeholder="Search" aria-label="Search" />
          <li><a href="/home" class="nav-link"><span class="oi oi-home"></span>
              Home</a></li>
          @can('manage-users')
          <li>
          ...
          <li>
            <a href="{{ route('categories.index') }}" class="nav-link"><span class="oi oi-tag"></span> Manage
              Categories</a>
          </li>
          @endcan
          @can('manage-books')
          <li>
            <a href="{{ route('books.index') }}" class="nav-link"><span class="oi oi-book"></span>Manage Books</a>
          </li>
          @endcan
          @can('manage-orders')
          <li>
            <a href="{{ route('orders.index') }}" class="nav-link"><span class="oi oi-inbox"></span> Manage Orders</a>
          </li>
          @endcan
  ...
  <script src="https://code.jquery.com/jquery-3.3.1.min.js"
    integrity="sha256-FgpCb/KJQlLNfOu91ta32o/NMZxltwRo8QtmkMRdAu8=" 1 1 1 2 3 4 5 crossorigin="anonymous"></script>
